          ...
          <div className="grid sm:grid-cols-2 gap-4">
            <div>
              ...
              <input
                ...
                required
                className="w-full px-4 py-2.5 border border-slate-200 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 text-slate-900 placeholder-slate-400"
                placeholder="JUAN"
              />
            </div>
            <div>
        ...
        <div>
          ...
          <div className="mt-4">
            ...
            <input
              ...
              onChange={handleChange}
              required
              className="w-full sm:w-48 px-4 py-2.5 border border-slate-200 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 text-slate-900 placeholder-slate-400"
